//! Valid Ed25519 key material used as fixtures across this crate's tests.
//!
//! These are the published RFC 8032 §7.1 test vectors, so they are known-good
//! encodings that do not depend on this crate's random source. A fixture that
//! changed every run would make a `PeerId` mapping, a join-ticket string, and a
//! two-swarm loopback test impossible to assert against byte for byte — and
//! determinism is the point (AC13).
//!
//! Deliberately a duplicate of the equivalent fixture file in the context and
//! store crates: contexts never import each other (canvas §4), a shared
//! test-fixture crate would be exactly such a coupling, and an infrastructure
//! crate reaching into a context's private test module could not compile
//! anyway.

use shared_types::PeerId;

/// RFC 8032 §7.1 TEST 1 secret key — the seed [`alice`] is derived from.
...
pub(crate) const ALICE_PUBLIC_KEY: [u8; 32] = [
    0xd7, 0x5a, 0x98, 0x01, 0x82, 0xb1, 0x0a, 0xb7, 0xd5, 0x4b, 0xfe, 0xd3, 0xc9, 0x64, 0x07, 0x3a,
    0x0e, 0xe1, 0x72, 0xf3, 0xda, 0xa6, 0x23, 0x25, 0xaf, 0x02, 0x1a, 0x68, 0xf7, 0x07, 0x51, 0x1a,
];

/// RFC 8032 §7.1 TEST 2 secret key — the seed [`bob`] is derived from.
pub(crate) const BOB_SECRET_KEY: [u8; 32] = [
    0x4c, 0xcd, 0x08, 0x9b, 0x28, 0xff, 0x96, 0xda, 0x9d, 0xb6, 0xc3, 0x46, 0xec, 0x11, 0x4e, 0x0f,
    0x5b, 0x8a, 0x31, 0x9f, 0x35, 0xab, 0xa6, 0x24, 0xda, 0x8c, 0xf6, 0xed, 0x4f, 0xb8, 0xa6, 0xfb,
];

/// RFC 8032 §7.1 TEST 2 public key.
pub(crate) const BOB_PUBLIC_KEY: [u8; 32] = [
    0x3d, 0x40, 0x17, 0xc3, 0xe8, 0x43, 0x89, 0x5a, 0x92, 0xb7, 0x0a, 0xa7, 0x4d, 0x1b, 0x7e, 0xbc,
    0x9c, 0x98, 0x2c, 0xcf, 0x2e, 0xc4, 0x96, 0x8c, 0xc0, 0xcd, 0x55, 0xf1, 0x2a, 0xf4, 0x66, 0x0c,
];

/// RFC 8032 §7.1 TEST 3 public key.
pub(crate) const CAROL_PUBLIC_KEY: [u8; 32] = [
